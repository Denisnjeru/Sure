...
const rfq = {
    ...
    rfqUploadCurrentSupplierTemplate(content,rfq_id,category_id){
        return new Promise((resolve, reject) => {
            api.post(`/rfq/categories/${rfq_id}/upload/current_prices/template/${category_id}/`,content,(data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    rfqAdvancedSubmit(content,supplier_id,category_id){
        return new Promise((resolve, reject) => {
            api.post(`/rfq/supplier/submit/advanced_rfq/${supplier_id}/${category_id}/`,content,(data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    advancedSupplierRFQResponse(supplier_id,category_id){
        return new Promise((resolve, reject) => {
            api.get(`rfq/supplier/submit/advanced_rfq/${supplier_id}/${category_id}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
