...
const system_management = {
    ...
    user(userId) {
        return new Promise((resolve, reject) => {
            api.get(`/buyer/users/${userId}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    updateUser(userId, content) {
        return new Promise((resolve, reject) => {
            api.put(`/buyer/users/${userId}/`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    role(roleId) {
        return new Promise((resolve, reject) => {
            api.get(`/buyer/roles/${roleId}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    updateRole(roleId, content) {
        return new Promise((resolve, reject) => {
            api.put(`/buyer/roles/${roleId}/`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    deleteRole(roleId) {
        return new Promise((resolve, reject) => {
            api.delete(`/buyer/roles/${roleId}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    rolePrivileges(roleId) {
        return new Promise((resolve, reject) => {
            api.get(`/buyer/role/privileges/${roleId}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    assignRolePrivilege(roleId, content) {
        return new Promise((resolve, reject) => {
            api.post(`/buyer/role/privileges/${roleId}/`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    deleteRolePrivilege(roleId, privilegeId) {
        return new Promise((resolve, reject) => {
            api.delete(`/buyer/role/privileges/${roleId}/${privilegeId}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
