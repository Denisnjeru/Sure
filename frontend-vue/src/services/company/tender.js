...
const tender = {
    tenders(page, dataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    job_search(page, key, dataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/search/${key}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    categories(id, page, dataPerPage){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    category_search(tender_id, key, page, dataPerPage){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${tender_id}/search/${key}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    sections(category_id, page, sectionDataPerPage){
        return new Promise((resolve, reject) => {
            api.get(`/tender/sections/${category_id}/?page=${page}&page_size=${sectionDataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    section_search(category_id, query, page, sectionDataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/sections/${category_id}/search/?query=${query}&page=${page}&page_size=${sectionDataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    technical_bidders(tender_id, category_id, page, dataPerPage){
        return new Promise((resolve, reject) => {
            api.get(
                `/tender/categories/${tender_id}/technical/bidders/${category_id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    search_technical_bidders(id, job_id, page, key, dataPerPage){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${job_id}/technical/bidders/search/${id}/?query=${key}&page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    items(tender_id, category_id, page, dataPerPage){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${tender_id}/items/${category_id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    financial_participants(tender_id, category_id, page, dataPerPage){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${tender_id}/financial/bidders/${category_id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    refresh_category_scores(tender_id, category_id){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${tender_id}/refresh/scores/${category_id}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    questions(section_id, page, dataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/questions/${section_id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    search_questions(section_id, key, page, dataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/questions/${section_id}/search/?query=${key}&page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    qualified_bidders(job_id, category_id, page, dataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${job_id}/qualified/bidders/${category_id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    unqualified_bidders(job_id, category_id, page, dataPerPage) {
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${job_id}/unqualified/bidders/${category_id}/?page=${page}&page_size=${dataPerPage}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    savings_report(tender_id){
        return new Promise((resolve, reject) => {
            api.get(`/tender/savings/report/${tender_id}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    financial_report(tender_id, category_id){
        return new Promise((resolve, reject) => {
            api.get(`/tender/categories/${tender_id}/financial/report/${category_id}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    ratios_report(category_id){
        return new Promise((resolve, reject) => {
            api.get(`/tender/category/reports/${category_id}/financial/ratios/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    ratios_qa(category_id, participant_id, form_data){
        return new Promise((resolve, reject) => {
            api.post(`/tender/qa/${category_id}/ratios/qa/${participant_id}/`, form_data, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    send_broadcast_notification(prequal_id, content){
        return new Promise((resolve, reject) => {
            api.post(`/tender/notifications/${prequal_id}/broadcast/`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    send_job_email_notification(prequal_id, content){
        return new Promise((resolve, reject) => {
            api.post(`/tender/notifications/${prequal_id}/email/`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    send_job_sms_notification(prequal_id, content){
        return new Promise((resolve, reject) => {
            api.post(`/tender/notifications/${prequal_id}/sms/`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    send_invite_email(prequal_id){
        return new Promise((resolve, reject) => {
            api.get(`/tender/notifications/${prequal_id}/email/invite/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    send_invite_sms(prequal_id){
        return new Promise((resolve, reject) => {
            api.get(`/tender/notifications/${prequal_id}/sms/invite/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
