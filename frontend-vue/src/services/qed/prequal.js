...
const prequal = {
    prequals(page, buyerId) {
        buyerId = buyerId || null;

        return new Promise((resolve, reject) => {
            api.get(`/prequal/?company_id=${buyerId}&page=${page}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    prequal(id, buyerId) {
        ...
        return new Promise((resolve, reject) => {
            api.get(`/prequal/${id}/?company_id=${buyerId}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    categories(id, page, buyerId){
        buyerId = buyerId || null;

        return new Promise((resolve, reject) => {
            api.get(`/prequal/categories/${id}/?company_id=${buyerId}&page=${page}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    category_participants(id, job_id, page){
        return new Promise((resolve, reject) => {
            api.get(`/prequal/categories/${job_id}/participants/${id}/?page=${page}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    create(content, buyerId){
        ...
        return new Promise((resolve, reject) => {
            api.post(`/prequal/?company_id=${buyerId}`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    update(prequal_id, content, buyerId){
        buyerId = buyerId || null;

        return new Promise((resolve, reject) => {
            api.put(`/prequal/${prequal_id}/?company_id=${buyerId}`, content, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    sections(category_id, page) {
        return new Promise((resolve, reject) => {
            api.get(`/prequal/sections/${category_id}/?page=${page}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    section_search(category_id, query) {
        return new Promise((resolve, reject) => {
            api.get(`/prequal/sections/${category_id}/search/?query=${query}`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
    ...
    questions(section_id) {
        return new Promise((resolve, reject) => {
            api.get(`/prequal/questions/${section_id}/`, (data) => {
                resolve(data);
            }, (error) => {
                reject(error);
            });
