        ...
        <div class="page__content columns">
            <div class="column-details column">
                ...
                <div class="column-details__content">
                    <p><strong>Type:</strong> Foward Auction</p>
                    <hr>
                ...
                <div class="column-details__content">
                    <div class="columns document">
                        ...
                        <div class="column is-8">
                            <a href="#"  class="button is-block is-primary">
                                View Reports
                            </a>
                        </div>
                        <div class="column is-2"></div>
                    ...
                    <div class="columns detail">
                        <div class="column is-2"></div>
                        <div class="column is-8">    
                        <router-link :to="'/buyer/inivited/suppliers/'+auction.id+'/foward/auction'" class="button is-block is-primary">
                            ...
                            <div class="dropdown-menu" id="dropdown-menu3" role="menu">
                                <div class="dropdown-content">
                                    ...
                                    <template v-if="auction.is_open === false">
                                        <router-link :to="'/buyer/foward/'+row.id+'auction/edit/item'" class="dropdown-item" style="margin-right: 2px;">
...
export default {
    name: 'foward-auction-details-buyer',
    data () {
        return{
    ...
    computed:{
        status(){
            return this.auction.is_open ? 'Open': 'Closed'
        },
    ...
    methods:{
        ...
        addAuctionItem: function(){
            this.$router.push('/buyer/foward/'+this.$route.params.auctionId+'/auction/add/item')
        },
        async onRowClick(actitm) {
            this.$router.push('/buyer/item/'+ this.$route.params.auctionId +'/'+  actitm.id  +'/foward/auction')
        },
        async getFoward(){
            try{
