        ...
        <div class="page__content">
            <div class="columns is-centered">
                <div class="column-details column is-12">
                    <form v-on:submit.prevent="edit_foward_auction()" enctype="multipart/form-data">
                        <div class="column-details__head">
                            <p class="column-details__head--title">Edit a Foward Auction</p>
...
import auctions from '@/services/company/auction'
    ...
    export default {
        name:'edit-foward-auction-buyer',
        data(){
            return{
                selectedType: '',
        ...
        methods:{
            ...
            removeexcelfile(){
                this.foward_auction.event_template = null;
                this.ExcelfileNames = []
            },
            ...
            async edit_foward_auction(){
                try {
                    if (this.foward_auction.name !== ''  && this.foward_auction.opening_date  !== '' && this.foward_auction.closing_date !== ''){
                        ...
                        if ((this.foward_auction.supporting_document !== null) && (typeof this.foward_auction.supporting_document != 'string')){
                            fd.append('supporting_document',this.foward_auction.supporting_document)
                        }

                        if ((this.foward_auction.excel_template !== null) && (typeof this.foward_auction.excel_template != 'string')){
            ...
            async get_auction(){
                try{
                    ...
                    this.foward_auction = response.data
                    console.log(this.foward_auction)
                }catch (err){
