        ...
        <div class="page__content">
            <div class="columns is-centered">
                <div class="column-details column is-12">
                    <form v-on:submit.prevent="edit_foward_auction_item()" enctype="multipart/form-data">
                            ...
                            <div class="columns">
                                <div class="column">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea class="input" type="text" placeholder="Enter description" rows="10" cols="50" v-model="item_foward_auction.description" required></textarea>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label class="label">Short Description </label>
                                        <div class="control">
                                            <input class="input" type="text" placeholder="Enter short description" v-model="item_foward_auction.short_description" required>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label class="label">Reserve Prices <span class="required">*</span></label>
                                        <div class="control">
                                            <input class="input" type="number" step="any" v-model="item_foward_auction.reserve_price" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="column">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input class="input" type="number" step="any" v-model="item_foward_auction.minimum_increment" required/>
                                        </div>
                                    </div>
                                    <div class="document">
...
import auctions from '@/services/company/auction'
    ...
    export default {
        name: 'foward-auction-edit-item-buyer',
        data(){
            return{
                item_foward_auction: {},
                error_text: '',
        ...
        methods:{
            removemainimage(){
                this.item_foward_auction.main_image = null;
            ...
            async edit_foward_auction_item(){
                try {
                    const fd = new FormData()
                    ...
                    fd.append('reserve_price',this.item_foward_auction.reserve_price)
                    fd.append('minimum_price',this.item_foward_auction.minimum_price)
                    fd.append('minimum_increment',this.item_foward_auction.minimum_increment)

                    if ((this.item_foward_auction.main_image !== null) && (typeof this.item_foward_auction.main_image  != 'string')){
                    ...
                    if(response.status == 200){
                        ...
                        window.toast.fire({icon: 'success', title: "Auction item updated successfully"})
                        this.$router.push('/buyer/item/'+ this.$route.params.auctionId +'/'+this.$route.params.itemId + '/foward/auction')
                    }
                }catch(error){
            ...
            async get_item(){
                try {
                    ...
                    this.item_foward_auction = response.data
                    console.log(this.item_foward_auction)
                }catch(err){
