        ...
        <div class="page__content">
            <div class="columns is-centered">
                <div class="column-details column is-12">
                    <form v-on:submit.prevent="create_reverse_auction()" enctype="multipart/form-data">
                        <div class="column-details__head">
                            <p class="column-details__head--title">Create a Reverse Auction</p>
                                ...
                                <div class="column">
                                    ...
                                    <!-- <div class="field">
                                        ...
                                        <div class="select">
                                            ...
                                            <select  v-model="selectedPricingMethod" id="selectMethod" required>
                                    ...
                                    <!-- <div class="selected">
                                        <span v-if="selectedPricingMethod != ''">
                                            <span class="selected__item currency">
                                                ...
                                                <span @click="removeselectedpricing()" class="selected__icon">
                                                    <img class="selected__icon--img" src="@/assets/Vector.png" alt="">
                                                </span>
                                            </span>
                                        </span>
...
import auctions from '@/services/company/auction'
    ...
    export default {
        name:'add-reverse-auction-buyer',
        data(){
            return{
                selectedType: '',
                selectedPricingMethod: '',
        ...
        methods:{
            ...
            removeexcelfile(){
                ...
                this.reverse_auction.excelformData = fd
                this.ExcelfileNames = []
            },
            removesupportingdocfile(){
                const fd = new FormData()
                this.reverse_auction.supportingdocformData = fd
            ...
            selectExcelDocument(event){
                ...
                if (!fileList.length) return;
                this.reverse_auction.event_template = event.target.files[0]
                ...
                console.log(this.reverse_auction.event_template)
            },
            async create_reverse_auction(){
                try {
                    if (this.reverse_auction.name !== ''  && this.reverse_auction.opening_date  !== '' && this.reverse_auction.closing_date !== ''){
                        ...
                        fd.append('pricing_method',this.reverse_auction.pricing_method)
                        ...
                        if (this.reverse_auction.supporting_document !== null){
                            fd.append('supporting_document',this.reverse_auction.supporting_document)
                        }

                        if (this.reverse_auction.excel_template !== null){
                        ...
                        const response = await auctions.createReverseAuctions(fd)
