    ...
    <div class="reverse_auction">
        <div class="page__head">
            ...
            <div class="page__head--links">
                <router-link to="/buyer/add/reverse/auction">
                            ...
                            <div class="dropdown-menu" id="dropdown-menu3" role="menu">
                                <div class="dropdown-content">
                                    ...
                                    <template v-if="row.is_open === false">
                                        <router-link :to="'/buyer/edit/'+row.id+'/reverse/auction'" class="dropdown-item" style="margin-right: 2px;">
...
export default {
    name: 'reverse-auction-list-buyer',
    data () {
        return{
    ...
    methods:{
        ...
        async onRowClick(auc) {
            this.$router.push('/buyer/'+ auc.id +'/reverse/auction')
        },
        async getReverseAuctions(){
            try{
                const response = await auctions.reverseAuctions()
                this.reverse_auctions = response.data.data
            } catch(error){
                console.log(error)
            }
        },
