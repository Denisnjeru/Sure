            ...
            <div class="column is-12 column-details">
                ...
                <div class="column-details__content">
                    ...
                    <div class="field" v-else>
                        ...
                        <a class="button blue-button" @click="downloadContract()">
                        ...
                        <div class="file has-name">
                            <label class="file-label">
                                <input required class="file-input" type="file" name="contractDocument" @change="handleContractDocument">
                                <span class="file-cta">
                        ...
                        <div class="field">
                            <div class="select">
                                <select class="revisions-select">
                                    <option @click="selectRevision(revision)" v-for="revision in contract.revisions" :key="revision.id">{{revision.editor}} - {{revision.updated}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
