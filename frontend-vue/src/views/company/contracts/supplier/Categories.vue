            ...
            <div class="column is-12 column-page">
                <div class="table-search">
                    <p class="table-search__instruction">
                       <span v-if="selectedJob !== null">{{selectedJob.title}} -</span>Select a category against which you want to award a contract
                    </p>
...
export default {
    ...
    methods: {
        selectCategory: function(category) {
            this.$store.dispatch('Contracts/setSelectedCategory', {category})
            this.$router.push('/buyer/contracts/supplier/categories/' + category.id + '/contracts')
        },
        async getCategories() {
