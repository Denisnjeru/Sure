  ...
  <div class="dashboard">
        <div class="page__head">
            ...
            <div class="page__head--links">
                    <router-link to="/company/create/prequalification" class="button is-primary is-small">
                  ...
                  <div class="dropdown-menu" id="dropdown-menu3" role="menu">
                      <div class="dropdown-content">
                        ...
                        <template v-if="row.is_open === false">
                          <router-link :to="'/company/edit/prequalification/'+row.id" class="dropdown-item" style="margin-right: 2px;">
...
export default {
  ...
  methods: {
    ...
    async search() {
      if (this.search_key != ""){
        try{
          let response = await prequal.job_search(this.page, this.search_key)
          this.page = 1
    ...
    async getPrequals(){
      if (this.search_key != ""){
        ...
        try{
          let response = await prequal.prequals(this.page)
          this.prequals = response.data['results']
          this.dataCount = response.data['count']
