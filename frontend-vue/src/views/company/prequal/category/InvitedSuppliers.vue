...
<div class="dashboard">
    <div class="page__head">
      <span class="page__head--title">
         Prequalification > {{ category.name }} > Invited Suppliers
      </span>
...
export default {
    ...
    return{
      ...
      options: {
        ...
        async requestFunction(data) {
          console.log(data)
          try {
            let response = await prequal.invited_suppliers(
                this.$route.params.prequal_id, this.$route.params.category_id,this.page)
            let response_data = {
  ...
  methods:{
    ...
    async submitEmailInvites(){
      try{
        let response = await prequal.email_invite_suppliers(
            this.$route.params.prequal_id, this.$route.params.category_id, this.form
        )
    ...
    async getCategory(){
      try{
        let response = await prequal.category(
