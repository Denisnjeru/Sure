...
<!--                        <input @keyup.enter="search()" class="table-search__search&#45;&#45;input" type="text" placeholder="Search here">-->
              ...
              <v-client-table :columns="columns" :options="options" :data="participants">
                ...
                <span slot="Actions" slot-scope="{row}">
                  <router-link :to="'/company/prequal/dd/supplier/questions/'+$route.params.category_id+'/'+row.id" class="button is-primary is-small">
...
export default {
  ...
  methods: {
    ...
    async get_participants(){
      try{
        let response = await prequal.dd_participants(this.$route.params.category_id)
