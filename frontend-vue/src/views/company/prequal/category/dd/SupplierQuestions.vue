...
<div class="dashboard">
        <div class="page__head">
            ...
            <div class="page__head--links">
                    <router-link :to="'/company/prequal/dd/add/supplier/questions/'+$route.params.category_id+'/'+$route.params.participant_id" class="button is-primary">
...
<!--                        <input @keyup.enter="search()" class="table-search__search&#45;&#45;input" type="text" placeholder="Search here">-->
              ...
              <v-client-table :columns="columns" :options="options" :data="questions">
                ...
                <span slot="Actions" slot-scope="{row}">
                  <router-link :to="'/company/prequal/dd/conduct/'+$route.params.category_id+'/'+$route.params.participant_id+'/'+row.id" class="button is-primary is-small">
...
export default {
  ...
  methods: {
    ...
    //   try{
    //     let response = await prequal.supplier(
    ...
    async get_participant_questions(){
      try{
        let response = await prequal.dd_participant_questions(
            this.$route.params.category_id, this.$route.params.participant_id
        )
