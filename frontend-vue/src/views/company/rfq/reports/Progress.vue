    ...
    get_task_progress(task_id) {
      ...
      function customResult(resultElement, result) {
        ...
        if (result['response_message'] === 'Report generated successfully') {
          ...
          $(resultElement).append(
              $('<a href="'+process.env.VUE_APP_DOWNLOAD_URL +'/' + result['filepath'] + '" class="button is-primary is-pulled-right" download="download">Download Report</a>')
          );
          // this.$router.push(`/company/prequal/reports/${this.$route.params.prequal_id}`)
        }
      }
