                ...
                <div class="column-details column is-6">
                    <form v-on:submit.prevent="create_risk_category()">
                        <div class="column-details__head">
                            <p class="column-details__head--title">Edit Section In January Risk Management 2022</p>
                        ...
                        <div class="column-details__content">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" placeholder="Enter category code">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Section Description<span class="required">*</span></label>
                                <div class="control">
                                    <textarea class="input" name="description" spellcheck="true" rows="10"/>
                                </div>
                            </div>
                            <div class="field">
                            ...
                            <div class="selected">
                                <span class="selected__item currency">
                                    Litigation and business probity
...
<script>
    export default {
        name:'edit-risk-management-section-buyer',
        data(){
            return{
