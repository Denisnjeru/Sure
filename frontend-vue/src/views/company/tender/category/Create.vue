            ...
            <div class="column-details__content">
              ...
              <div class="columns">
                <div class="column">
                  ...
                  <div class="field">
                    <label class="label">Template Type<span class="required"> *</span></label>
                    <div class="control" style="margin-left:10px;">
                      <label class="radio">
                        <input  type="radio" id="basic" value="basic" v-model="form.rfq_type">
                        Basic
                      </label>
                      <label class="radio">
                        <input type="radio" id="advanced" value="advanced" v-model="form.rfq_type">
                        Advanced
                      </label>
                    </div>
                  </div>
                ...
                <div class="column">
                  ...
                  <div class="field">
                    ...
                    <a :href="MEDIA_URL+'media/templates/Tender_RFQ_Template.xlsx'" class="button button-submit is-small">Download Template</a>
                    <div class="control" style="margin-top:2%;">
                      <input class="input" type="file" @change="selectItemTemplate($event)">
                    </div>
                  </div>

                  <div class="field" v-show="form.rfq_type == 'basic'">
                    <label class="label">Inclusive VAT<span class="required">*</span></label>
                    <div class="control" style="margin-left:10px;">
                      <label class="radio">
                        <input type="radio" id="yes" value="Yes" v-model="form.vatable">
                        Yes
                      </label>
                      <label class="radio">
                        <input type="radio" id="no" value="No" v-model="form.vatable">
                        No
                      </label>
                    </div>
                  </div>

                  <div class="field" v-show="form.vatable === 'Yes' && form.rfq_type =='basic'">
                    <label class="label">VAT Rate<span class="required">*</span></label>
                    <div class="control">
                      <input class="input" name="vat_rate" type="number" v-model="form.vat_rate" placeholder="default is 16%">
                    </div>
                  </div>
...
export default {
  ...
  data() {
    return {
      ...
      MEDIA_URL: process.env.VUE_APP_DOWNLOAD_URL
    }
  },
  methods: {
    async create() {
      ...
      form_data.append("rfq_type", this.form.rfq_type);
      form_data.append("vatable", this.form.vatable);
      form_data.append("vat_rate", this.form.vat_rate);
