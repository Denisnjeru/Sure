          ...
          <div class="column is-3">
            <template>
              <router-link v-if="tender_job.has_custom_letter === false"
                           :to="'/company/tender/letters/custom/create/'+this.$route.params.job_id"
                           style="margin-right: 2px" class="button is-primary is-small is-block">
                Custom Letter
              </router-link>
              <router-link v-else-if="tender_job.has_custom_letter === true"
                           :to="'/company/tender/letters/custom/edit/'+this.$route.params.job_id"
                           style="margin-right: 2px" class="button is-primary is-small is-block">
                Custom Letter
              </router-link>
            </template>
          ...
          <div class="column is-3">
            <template>
              <router-link v-if="tender_job.has_dd_letter === false"
                  :to="'/company/tender/letters/dd/create/'+this.$route.params.job_id"
                           style="margin-right: 2px" class="button is-primary is-small is-block">
                DD Letter
              </router-link>
              <router-link v-else-if="tender_job.has_dd_letter === true"
                  :to="'/company/tender/letters/dd/edit/'+this.$route.params.job_id"
                           style="margin-right: 2px" class="button is-primary is-small is-block">
                DD Letter
              </router-link>
            </template>
          ...
          <div class="column is-3">
            <template>
              <router-link v-if="tender_job.has_regret_letter === false"
                  :to="'/company/tender/letters/regret/create/'+this.$route.params.job_id"
                           style="margin-right: 2px" class="button is-primary is-small is-block">
                Regret Letter
              </router-link>
              <router-link v-else-if="tender_job.has_regret_letter === true"
                  :to="'/company/tender/letters/regret/edit/'+this.$route.params.job_id"
                           style="margin-right: 2px" class="button is-primary is-small is-block">
                Regret Letter
              </router-link>
            </template>
          ...
          <div class="column is-3">
            <template>
              <router-link v-if="tender_job.has_success_letter === false"
                  :to="'/company/tender/letters/success/create/'+this.$route.params.job_id"
                           class="button is-primary is-small is-block">
                Success Letter
              </router-link>
              <router-link v-if="tender_job.has_success_letter === true"
                  :to="'/company/tender/letters/success/edit/'+this.$route.params.job_id"
                           class="button is-primary is-small is-block">
                Success Letter
              </router-link>
            </template>
...
export default {
  ...
  methods: {
    ...
    async getCategories() {
      try {
        let response = await tender.categories(this.$route.params.job_id, this.page, this.dataPerPage)
