            ...
            <div class="column is-12">
              <form @submit.prevent="submitLetter()">
                ...
                <div class="field is-fullwidth">
                  <label>Subject</label>
                  <div class="control">
                    <input type="text" v-model="form.subject" class="input" required />
                ...
                <div class="columns">
                  <div class="column">
                    <div class="field is-fullwidth">
                      ...
                      <div class="control">
                        <input type="file" class="input" @change="selectHeader($event)">
                    ...
                    <div class="field is-fullwidth">
                      ...
                      <div class="control">
                        <input type="file" class="input" @change="selectSignature($event)">
                  ...
                  <div class="column">
                    <div class="field is-fullwidth">
                      ...
                      <div class="control">
                        <input type="file" class="input" @change="selectFooter($event)">
                    ...
                    <div class="field is-fullwidth">
                      ...
                      <div class="control">
                        <input type="file" class="input" @change="selectWatermark($event)">
...
export default {
  ...
  methods:{
    ...
    async getLetter(){
      try{
        let response = await tender.job_client_document(this.$route.params.job_id, 'custom')
    ...
    async submitLetter(){
      ...
      form_data.append("tender", this.$route.params.job_id)
      form_data.append("body", this.form.body)
      form_data.append("subject", this.form.subject)
      form_data.append("authoriser_name", this.form.authoriser_name)
      form_data.append("authoriser_role", this.form.authoriser_role)
      form_data.append("document_type", "custom")
      form_data.append("tendersure_module", "letters")

      try{
        let response = await tender.update_client_document(form_data, this.$route.params.job_id, 'custom')
        if(response.status === 200){
          this.$router.push(`/company/tender/letters/${this.$route.params.job_id}`)
        }else{
          window.toast.fire({icon: 'error', title: 'Error. Please Try Again!'})
        }
      }catch(err){
