        ...
        <div class="columns" v-if="section_questions">
          <div class="column is-12" style="padding: 16px 24px;">
            <div id="accordion_second">
              ...
              <template v-else>
                <div class="field">
                  <router-link :to="'/company/tender/category/details/'+sections[0].tender_id+'/'+$route.params.category_id" type="button" class="button is-primary is-small is-pulled-right">Finish</router-link>
                </div>
              </template>
            </div>
          </div>
