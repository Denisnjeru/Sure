            ...
            <div class="column is-12 column-page">
                <div class="table-search">
                    <p class="table-search__instruction">
                       Select buyer company (Current Contracts with QED)
                    </p>
...
export default {
    ...
    data() {
        return {
            ...
            options: {
                sortable: ['company_name', 'buyer_initials'],
                perPageValues: [20], 
                filterable: false
            },
            page: 1,
    ...
    methods: {
        selectBuyer: function(buyer) {
            this.$store.dispatch('Contracts/setSelectedBuyer', {buyer})
            this.$router.push('/qed/contracts/buyer/' + buyer.id + '/contracts')
        },
        async getBuyers() {
            try {
                const response = await contracts.buyers()
