    ...
    <div class="dashboard">
        <div class="page__head">
            <span class="page__head--title">
                QED Contracts - {{selectedBuyer.company_name}}
            </span>

            <div class="page__head--links">
                <router-link :to="'/qed/contracts/buyer/' + selectedBuyer.id + '/jobs'">
            ...
            <div class="column is-12 column-page">
                <div class="table-search">
                    <p class="table-search__instruction">
                       Uploaded Contracts (Current Contracts with {{selectedBuyer.company_name}})
                    </p>
                ...
                <v-client-table :columns="columns" :data="contracts" :options="options" class="hasRowNo hasNoWrap">
                    ...
                    <span class="actions" slot="actions" slot-scope="{row}">
                        <router-link :to="'/qed/contracts/buyer/contract/' + row.id + '/update'">
            ...
            <div class="popup" v-if="popContractView === true && selectedContract.target !== undefined">
                <span class="popup__details">
                    <div class="page__head">
                        ...
                        <div class="page__head--links">
                            <router-link :to="'/qed/contracts/buyer/contract/' + selectedContract.id + '/update'">
                                <a class="page__head--link button button-link">
...
export default {
    ...
    computed: {
        ...
        ...mapGetters('Contracts',['selectedBuyer',]),
    },
    mounted() {
        this.getContracts()
    },
    methods: {
        ...
        async getContracts() {
            try {
                const response = await contracts.qedContracts(this.$route.params.buyerId)
