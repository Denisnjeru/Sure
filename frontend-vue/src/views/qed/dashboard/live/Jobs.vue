            ...
            <div class="column is-12 column-page">
                ...
                <v-client-table :columns="columns" :data="jobs" :options="options" class="hasRowNo">
                    ...
                    <p class="standard-column link" slot="job" slot-scope="{row}">
                        <router-link :to="'/qed/livejobs/' + row.id + '/' + row.sourcing_activity + '/categories'">
                            {{ row.title }}
                        </router-link>
                    </p>
                    ...
                    <p class="centered" slot="responsive_bidders">
                        23
                    </p>
...
export default {
    ...
    data() {
        return {
            columns: ['#', 'company', 'job', 'code', 'sourcing_activity', 'responsive_bidders'],
            options: {
                sortable: ['company', 'job', 'code'],
                perPageValues: [20], 
                filterable: false
            },
            page: 1,
