                    ...
                    <div class="dropdown-menu" id="dropdown-menu3" role="menu">
                      <template v-if="row.has_award_letter === true">
                        <div class="dropdown-content">
                          <router-link :to="`/qed/prequal/preview/award/letter/${$route.params.job_id}/${$route.params.category_id}/${row.supplier.id}`" class="dropdown-item">
                      ...
                      <template v-else-if="row.has_regret_letter === true">
                        <div class="dropdown-content">
                          <router-link :to="`/qed/prequal/preview/regret/letter/${$route.params.job_id}/${$route.params.category_id}/${row.supplier.id}`" class="dropdown-item">
  ...
  methods: {
    ...
    async create_award_letter(row){
      ...
      try{
        ...
        this.$router.push(
            `/qed/prequal/preview/award/letter/${this.$route.params.job_id}/${this.$route.params.category_id}/${row.supplier.id}`
        )
      }catch (err){
        window.toast.fire({icon: 'error', title: err})
      }
    ...
    async create_regret_letter(row){
      ...
      try{
        ...
        this.$router.push(
            `/qed/prequal/preview/regret/letter/${this.$route.params.job_id}/${this.$route.params.category_id}/${row.supplier.id}`
        )
      }catch (err){
        window.toast.fire({icon: 'error', title: err})
      }
