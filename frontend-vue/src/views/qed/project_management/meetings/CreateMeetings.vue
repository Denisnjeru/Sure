<template>
    <div class="dashboard">
        ...
        <form class="form" v-on:submit.prevent="uploadMeetingMinutes()">
            ...
            <div class="column is-6 column-details">
                ...
                <div class="column-details__content">                    
                    <div class="field file-upload">
                        ...
                        <div class="control">
                            <input required type="file" id="meeting_minutes">
                        </div>
                    </div>  
                    <div class="field">
        ...
        <div class="columns additions">
            ...
            <div class="column is-3">
               <input type="submit" class="button button-submit" value="Upload">
            </div>
        </div>
        </form>     
    </div>
    ...
    methods: {
        ...
        async uploadMeetingMinutes(){
            try {
                ...
                await project_management.createMeeting(form_data)
                window.toast.fire({
                    icon: 'success',
                ...
                window.toast.fire({
                    icon: 'error',
                    title: 'Error occurred while creating meeting'
                })
            }
        },
