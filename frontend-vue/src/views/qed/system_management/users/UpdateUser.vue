...
export default {
    ...
    methods: {
        ...
        async getUser() {
            try {
                const response = await user_management.user(this.$route.params.id)
        ...
        async getRoles() {
            try {
                const response = await user_management.roles()
        ...
        async updateUser(){
            try {
                const response = await user_management.updateUser(this.$route.params.id, this.user)
                window.toast.fire({
                    icon: 'success',
