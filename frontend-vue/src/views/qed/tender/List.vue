  ...
  <div class="dashboard">
        <div class="page__head">
            ...
            <div class="page__head--links">
                    <router-link to="/qed/create/tender" class="button is-primary is-small">
                        New Tender
                    </router-link>
            </div>
        </div>
                    ...
                    <div class="dropdown-menu" id="dropdown-menu3" role="menu">
                      <div class="dropdown-content">
                        ...
                        <template v-if="row.is_open === false">
                          <router-link :to="'/qed/edit/tender/'+row.id" class="dropdown-item" style="margin-right: 2px;">
...
export default {
  ...
  methods: {
    ...
    tenderDetails(row){
      this.$router.push(`/qed/tender/details/${row.id}`)
    },
    async search() {
        console.log('search');
    },
    ...
    async getTenders(){
      try{
        let response = await tender.tenders(this.page, this.selectedBuyer.id)
