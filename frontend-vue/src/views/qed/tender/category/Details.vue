    ...
    <div class="dashboard">
      <div class="page__head">
        ...
        <div class="page__head--links">
          <router-link class="button is-primary is-small" :to="'/qed/tender/financial/details/'+tender.id+'/'+category.id">
            Financial Details
          </router-link>
        </div>
      </div>
          ...
          <div class="column-details__content">
            ...
            <div class="columns">
              ...
              <div class="column is-8">
                <a href="#" class="button is-primary is-block is-small">Refresh Scores</a>
              </div>
              <div class="column is-2">
            ...
            <div class="columns" v-if="category.invite_only === true">
              ...
              <div class="column is-8">
                <router-link
                    :to="'/qed/tender/invited/suppliers/'+$route.params.tender_id+'/'+$route.params.category_id"
          ...
          <div class="page__head">
            ...
            <div class="page__head--links column is-8" style="display: inline !important;">
              <div class="columns">
                ...
                <div class="column is-6">
                  <router-link :to="'/qed/tender/create/section/' + tender.id + '/' + category.id" 
            ...
            <div class="table-search">
              ...
              <v-client-table :columns="section_columns" :options="section_options" :data="sections">
                ...
                <span slot="Actions" slot-scope="{row}">
                  ...
                  <router-link :to="'/qed/tender/edit/section/'+tender.id+'/'+category.id+'/'+row.id"
                               class="button is-primary is-small" style="margin-right: 2px;">
                      <p><font-awesome-icon class="view__icon" icon="pencil-alt"/></p>
                  </router-link>

                  <router-link :to="'/qed/tender/section/questions/' + row.id"
...
export default {
  ...
  methods: {
    ...
    //   try {
    //     let response = await tender.technical_bidders(this.$route.params.tender_id, this.$route.params.category_id)
    //     this.dataCount = response.data['count']
