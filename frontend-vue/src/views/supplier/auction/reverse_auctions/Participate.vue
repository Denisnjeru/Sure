        ...
        <div class="page__content columns">
            <div class="column column-details">
                <div class="column-details__head">
                    ...
                    <p class="column-details__head--desc">Reverse Auction</p>
                </div>
                <div class="column-details__content">
                    <p class="custom_detail"><strong>Auction:</strong> {{ auct.name }}</p>
                    <hr>
                    <p class="custom_detail"><strong>Type:</strong> Reverse Auction</p>
                    <hr>
            ...
            <div class="column column-details">
                ...
                <div class="column-details__content">
                    ...
                    <div class="page__pagination">
                        <pagination style="padding: 0 10px !important" :records="auct.auction_items.length" v-model="page" :per-page="dataPerPage" @paginate="callback">
                        </pagination>
                    </div>
                    <span class="proceed">
