    ...
    <div class="dashboard">
        <div class="page__head">
            ...
            <div class="page__head--links">
                <router-link :to="'/supplier/user/users/create/'">
            ...
            <div class="column is-12 column-page">
                ...
                <v-client-table :columns="columns" :data="users" :options="options" class="hasNoWrap">
                    ...
                    <span class="view" slot="role" slot-scope="{row}">
                        <router-link :to="'supplier/system/roles/' + row.id + '/privileges'">
                            <span> {{row.supplier_role.name}}</span>
                        </router-link>
                    </span>
                    ...
                    <span class="actions" slot="actions" slot-scope="{row}">
                        <router-link :to="'/supplier/user/users/' + row.id + '/update'">
...
export default {
    ...
    data() {
        return {
            columns: ['name', 'email', 'status', 'role', 'last_login', 'invitation_email', 'date_joined', 'actions'],
            options: {
                sortable: ['name', 'email'],
                perPageValues: [20], 
                filterable: false
