...
<div class="dashboard">
        <div class="page__head">
            <span class="page__head--title">
               Tender > Category > Technical Details
            </span>
...
<!--                    </div>-->
              ...
              <div class="columns" style="padding: 6px 24px;">
                <div class="column is-6">
                  <span class="page__head--title" style="font-size: 12px"><strong>Job Title: </strong>{{ category.tender.title }}</span><br>
...
<!--                    <span class="page__head&#45;&#45;title"><strong></strong></span>-->
              ...
              <template v-if="category.participated === true">
                <router-link style="font-size: 12px" class="button is-primary is-pulled-right"
                             :to="'/supplier/tender/category/bid/'+category.id">
...
export default {
  ...
  methods:{
    async getTender(){
      try{
        let response = await supplier_tender.category_instructions(this.$route.params.category_id)
